...
public class UIForm extends javax.swing.JPanel implements UI, FormActionListener {
	 ...
	 * @param form
	 */
	public UIForm(Form form, FormActionPanel actionPanel, CreateComponent createComponent, UXConfig uxconfig) {
		this.form = form;
	...
	private void createInput(Input input, Container container, Integer x, Integer y, Integer width) {
		...
		JComponent textField = createComponent.create(input);
	...
	public void focusPath(List<String> path) {
		...
		if (component != null) {
			...
			component.setBackground(uxconfig.getDefaultErrorCollor());
